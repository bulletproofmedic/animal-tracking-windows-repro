...
class PackageIdentityTests(unittest.TestCase):
    def test_exact_bytes_reuse_supplied_identity_and_property(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            resolved = resolve_identity(
                ...
                supplied_property="property-1",
                receipt=receipt(archive, supplied),
            )

            self.assertEqual(resolved, (supplied, "property-1", "SUPPLIED"))
    ...
    def test_metadata_only_repack_cannot_inherit_identity(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            resolved_id, property_id, scheme = resolve_identity(
                archive,
                supplied_id=supplied,
                supplied_property="property-1",
