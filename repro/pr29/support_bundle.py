...
def create_support_bundle(
    ...
    *,
    ...
    The API deliberately accepts only redacted logs and governed metadata classes. It has
    no input for media, maps, backups, arbitrary files, or exact-coordinate exports.
    """
